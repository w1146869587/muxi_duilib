...
public:
	...
	void SetMinInfoWithNoScale(int cx, int cy);
	...
	const CDuiString& GetSkinFolder(); //hunter
	...
	void SetSkinFolder(LPCTSTR pStrPath); //hunter
	...
	//static void ReloadSharedImages(); // hunter
	void ReloadImages();
    ...
    void SetFocus(CControlUI* pControl, bool isForce = false);
