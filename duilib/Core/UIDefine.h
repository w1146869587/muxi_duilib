...
typedef struct _WM_DUI_CONTROL_PAINT_LPARAM
{
	HDC hdc;
	bool bHandle;
	RECT paintRect;
}DUI_CONTROL_PAINT_LPARAM;
...
#define WM_DUI_CONTROL_BENGIN_PAINT	(WM_USER+2000)
...
#define DUI_MSGTYPE_DRAW				   (_T("draw"))
...
#define DUI_MSGTYPE_SELCHANGED			   (_T("selchanged"))
...
#define DUI_MSGTYPE_SELECTAGAIN 		   (_T("selectagain")) //option已经是选中状态，又点击一下

#define DUI_MSGTYPE_ITEMBTNDOWN           (_T("itembtndown"))

#define DUI_MSGTYPE_RICHEDIT_POSCHANGED	   (_T("richedit_poschanged"))		
#define DUI_MSGTYPE_RICHEDIT_SCROLL_POSCHANGED	   (_T("richedit_scroll_poschanged"))
//////////////////////////////////////////////////////////////////////////
...
#define	 DUI_CTR_WKEWINDOWLESSBROWSER			(_T("WkeWebBrowser"))
