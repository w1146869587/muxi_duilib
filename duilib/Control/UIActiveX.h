...
public:
	...
	static void PixelToHiMetric(const LPSIZEL lpSizeInPix, LPSIZEL lpSizeInHiMetric);
	static void HimetricToPixel(LPSIZEL lpSizeHiMetric, LPSIZEL lpSizelPixels);
