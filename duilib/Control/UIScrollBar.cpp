...
void CScrollBarUI::SetThumbVisible(bool bVisible) {
	m_bThumbVisible = bVisible;
}

bool CScrollBarUI::IsThumbVisible() {
	return m_bThumbVisible;
}
...
void CScrollBarUI::PaintThumb(HDC hDC)
{
	...
	if (m_dwThumbColor != 0 && !m_bThumbVisible) {
